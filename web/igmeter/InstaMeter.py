...
class InstaMeter:
    ...
    def print_account_statistic(self):
        ...
        worksheet_names = ['#comments','views/post','#post','#likes','comments/post','#following','#followers','likes/post','#video_views'] 
        stats = {
